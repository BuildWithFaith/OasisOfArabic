...
async function CheckoutSuccessContent({ searchParams }: { searchParams: Promise<{ orderId?: string }> }) {
...
export default function CheckoutSuccessPage({
  ...
  return (
    <div className="min-h-screen bg-slate-50 py-16 px-4">
      <Suspense fallback={<div className="text-center py-10">Validating payment status...</div>}>
