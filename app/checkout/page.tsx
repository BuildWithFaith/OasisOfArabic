...
async function CheckoutContent({ searchParams }: { searchParams: Promise<{ course?: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Suspense fallback={<div className="text-center py-12 text-slate-500">Loading checkout details...</div>}>
